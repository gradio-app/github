...
utils$8.toCommandProperties = utils$8.toCommandValue = void 0;
...
utils$8.toCommandValue = toCommandValue;
...
utils$8.toCommandProperties = toCommandProperties;
...
utils$6.getApiBaseUrl = utils$6.getProxyAgent = utils$6.getAuthString = void 0;
...
utils$6.getAuthString = getAuthString;
function getProxyAgent(destinationUrl) {
  const hc = new httpClient.HttpClient();
  return hc.getAgent(destinationUrl);
}
utils$6.getProxyAgent = getProxyAgent;
function getApiBaseUrl() {
  return process.env["GITHUB_API_URL"] || "https://api.github.com";
}
utils$6.getApiBaseUrl = getApiBaseUrl;
...
(function(exports) {
  ...
  const Utils = __importStar2(utils$6);
...
function match_filter(patterns, files) {
  return files.some((file) => picomatch$1.isMatch(file, patterns));
}
async function run() {
  var _a;
  ...
  const filters = JSON.parse(filter_file);
