...
async function run() {
  ...
  if (context.eventName === "push") {
    ...
    outputs.found_pr = !!(source_repo && source_branch && pr_number);
    outputs.mergeable = ((_e = context.payload.pull_request) == null ? void 0 : _e.mergeable) === true;
...
const empty_pr_details = {
  source_repo: void 0,
  source_branch: void 0,
  pr_number: void 0,
  sha: void 0,
  mergeable: void 0,
  merge_sha: void 0,
...
function get_pr_details_from_number(pull_requests, pr_number) {
  if (!pr_number)
    return empty_pr_details;
  const outputs = pull_requests.map((pr) => {
    var _a;
    return {
...
function get_pr_details_from_sha(pull_requests) {
  ...
  const outputs = pull_requests.map((pr) => {
    ...
    source_branch: (_c = context.payload.ref) == null ? void 0 : _c.split("/").slice(2).join("/"),
    sha: head_sha
  };
